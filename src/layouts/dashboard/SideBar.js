...
function getPath(index) {
  console.log("🚀 ~ file: SideBar.js:15 ~ getPath ~ index:", index)
  switch (index) {
    case 0:
      return "/app";
    case 1:
      ...
      >
        <Stack alignItems="center" spacing={4}>
          ...
          <Stack spacing={3} alignItems="center">
            {Nav_Buttons.map((val) => (
              ...
              >
                <IconButton
                  key={val.index}
                  sx={{ color: val.index === selected ? "white" : "black" }}
                  onClick={() => {
                    setSelected(val.index);
                    Navigate(getPath(val.index));
                  }}
                >
                  {val.icon}
                </IconButton>
          ...
          <Box
            ...
            sx={{
              backgroundColor:
                selected === 3 ? theme.palette.primary.main : "white",
              borderRadius: 1.5,
            }}
          >
            <IconButton
              ...
              sx={{ color: selected === 3 ? "white" : "black" }}
            >
              <Gear></Gear>
            </IconButton>
          </Box>
